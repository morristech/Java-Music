...
public class MyMusic {
	...
	public static void main(String[] args) {
		...
		c  d  e  f  g  a  b
		g  a  b  c  d  e  f#	                  [6]		arr.length - 1
		d  e  f# g  a  b  c#	      [2]         [6]		arr.length - 1, arr.length / 3
		a  b  c# d  e  f# g#	      [2]      [5][6]		arr.length - 1, arr.length - 2, arr.length / 3
		e  f# g# a  b  c# d#	   [1][2]      [5][6]		arr.length - 1, arr.length - 2, arr.length / 3, arr.length / 3 - 1
		b  c# d# e  f# g# a#	   [1][2]   [4][5][6]		arr.length - 1, arr.length - 2, arr.length - 3, arr.length / 3, arr.length / 3 - 1
		f# g# a# b  c# d# e#	[0][1][2]   [4][5][6]		arr.length - 1, arr.length - 2, arr.length - 3, arr.length / 3, arr.length / 3 - 1, arr.length / 3 - 2
		c# d# e# f# g# a# b#	[0][1][2][3][4][5][6]		arr.length - 1, arr.length - 2, arr.length - 3, arr.length - 4, arr.length / 3, arr.length / 3 - 1, arr.length / 3 - 2
